...
class Plotter {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Plotter.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_plotter_free(ptr);
    }
    /**
    * @returns {Plotter}
    */
    constructor() {
        const ret = wasm.plotter_new();
        return Plotter.__wrap(ret);
    }
    /**
    * @param {number} time
    */
    frame(time) {
        wasm.plotter_frame(this.ptr, time);
    }
}
__exports.Plotter = Plotter;
